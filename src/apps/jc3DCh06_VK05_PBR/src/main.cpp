...
int main ()
{
	...
	BL_CHECK ( setupAlternateDebugMessengerAndReportCallbacks ( vk.instance, &vk.messenger, &vk.reportCallback ) );
	VK_CHECK ( glfwCreateWindowSurface ( vk.instance, window, nullptr, &vk.surface ) );
	BL_CHECK ( initVulkanRenderDevice3 ( vk, vkDev, kScreenWidth, kScreenHeight ) );
	...
	modelPBR = std::make_unique<PBRModelRenderer> ( vkDev,
		(uint32_t)sizeof ( UBO ),
		appendToRoot ( "assets/models/DamagedHelmet/glTF/DamagedHelmet.gltf" ),
		appendToRoot ( "assets/models/DamagedHelmet/glTF/Default_AO.jpg" ),
		appendToRoot ( "assets/models/DamagedHelmet/glTF/Default_emissive.jpg" ),
		appendToRoot ( "assets/models/DamagedHelmet/glTF/Default_albedo.jpg" ),
		appendToRoot ( "assets/models/DamagedHelmet/glTF/Default_metalRoughness.jpg" ),
		appendToRoot ( "assets/models/DamagedHelmet/glTF/Default_normal.jpg" ),
		appendToRoot ( "assets/images/piazza_bologni_1k.hdr" ),
		appendToRoot ( "assets/images/piazza_bologni_1k_irradiance.hdr" ),
		depthTexture );
