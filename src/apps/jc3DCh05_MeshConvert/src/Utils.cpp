...
std::string readShaderFile ( const char* fileName )
{
	...
	// parse and eliminate UTF byte-order marker as it might not be handled proprerly by legacy GLSL compilers, especially on Android
	...
	// handle #include directives inside shader source code
