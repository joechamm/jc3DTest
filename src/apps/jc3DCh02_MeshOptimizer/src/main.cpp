...
int main ( void )
{
	...
	GLFWwindow* window = glfwCreateWindow ( 1024, 768, "MeshOptimizers example", nullptr, nullptr );
	if ( !window )
	{
		glfwTerminate ();
		exit ( EXIT_FAILURE );
	...
	const std::string sceneFilename = ROOT_DIR + std::string ( "assets/rubber_duck/scene.gltf" );
