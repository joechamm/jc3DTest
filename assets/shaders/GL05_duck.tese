...
// The two helper functions are useful to interpolate between vec2 and vec4 attribute values at the corners of the original triangle using barycentric coordinates of the current vertex.
