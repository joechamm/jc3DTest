...
namespace jcGLframework
{
	...
	public:
		ImGuiGLRenderer ()
		{
			...
			glBindBufferBase ( GL_UNIFORM_BUFFER, kIdxBind_PerFrameData, perFrameDataBuffer_.getHandle () );
	...
	private:
		...
		void defaultInitImGui ()
		{
			...
			ImFont* Font = io.Fonts->AddFontFromFileTTF ( fontFilename.c_str (), cfg.SizePixels, &cfg );
